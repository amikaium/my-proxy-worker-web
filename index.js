export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname.includes('gamex.689a2e64e46ee4d9cc7e.svg')) {
      ...
      // এখানে points="0,0 40,0 100,100 0,100" দিয়ে শেপটি তৈরি করা হয়েছে। 
      // 0,0 এবং 40,0 এর কারণে উপরে একটি ফ্ল্যাট জায়গা তৈরি হবে (একদম তীক্ষ্ণ কোণা হবে না)।
      // 100,100 এর কারণে নিচটা চওড়া হয়ে ডানদিকে বাঁকা হবে।
      const customSvg = `
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="none">
          <polygon points="0,0 40,0 100,100 0,100" fill="#56BAD9" />
        </svg>
      `;
