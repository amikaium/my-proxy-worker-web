    ...
    try {
      ...
      if (contentType.includes("text/html") || contentType.includes("application/javascript") || contentType.includes("text/javascript")) {
        ...
        if (contentType.includes("text/html")) {
            ...
            // ==========================================
            // 🖼️ স্পেসিফিক ব্যানার ইমেজ রিপ্লেসমেন্ট (Instant)
            // ==========================================
            const newBannerImage = "https://i.postimg.cc/d05XnH5B/20260414-035715.webp";
            
            // স্ক্রিনশটে থাকা এক্সাক্ট লিংক এবং রিলেটিভ পাথ রিপ্লেস করা হলো 
            // যাতে শুধুমাত্র এই ব্যানারটিই পরিবর্তন হয়
            text = text.replaceAll("https://baji11.online/pub-images/maza365/banner/banner-first-d.jpg", newBannerImage);
            text = text.replaceAll("https://www.baji11.live/pub-images/maza365/banner/banner-first-d.jpg", newBannerImage);
